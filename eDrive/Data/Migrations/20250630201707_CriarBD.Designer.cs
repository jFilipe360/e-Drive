...
namespace eDrive.Data.Migrations
{
    ...
    [Migration("20250630201707_CriarBD")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eDrive.Models.Aluno", b =>
                {
            ...
            modelBuilder.Entity("eDrive.Models.Aula", b =>
                {
            ...
            modelBuilder.Entity("eDrive.Models.Instrutor", b =>
                {
                    b.Property<int>("InstrutorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eDrive.Models.Presenca", b =>
                {
            ...
            modelBuilder.Entity("eDrive.Models.Aula", b =>
                {
                    b.HasOne("eDrive.Models.Instrutor", "Instrutor")
                        .WithMany("Aulas")
            ...
            modelBuilder.Entity("eDrive.Models.Presenca", b =>
                {
                    b.HasOne("eDrive.Models.Aluno", "Aluno")
                        .WithMany("Presencas")
                        .HasForeignKey("AlunoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eDrive.Models.Aula", "Aula")
                        .WithMany("Presencas")
